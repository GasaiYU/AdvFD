...
def get_fd_train_step(
    ...
    def fd_train_step():
        ...
        all_new_feats = []
        if not args.fd_sequential_backward:
            for feats in extract_judge_features_all(judges, sampled):
...
def get_args_parser():
    ...
    parser.add_argument("--fd_repr_models", type=str, nargs="+", default=["inception"],
                        help="feature extractors: 'inception', 'inception:Mixed_6e', "
                             "'qwen3vl_2b', a Qwen3-VL HF id, or timm model names")
