#!/usr/bin/env bash
# Table 3: JiT scalability at 256px with multi-layer Inception FD.
...
run_one "${MODEL}-fd-inception-pool3-5b-6a" \
    --fd_repr_models inception inception:Mixed_5b inception:Mixed_6a \
    --fd_repr_weights 1.0 1.0 1.0
